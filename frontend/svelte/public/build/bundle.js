...
var app = (function () {
	...
	/* src/TodoList.svelte generated by Svelte v4.2.19 */
	...
	function create_fragment$1(ctx) {
		...
		let mounted;
		let dispose;
		let each_value = ensure_array_like_dev(/*todoList*/ ctx[0]);
		let each_blocks = [];
		...
		const block = {
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen_dev(button0, "click", /*onIncrement*/ ctx[1], false, false, false, false),
						listen_dev(button1, "click", /*onDecrement*/ ctx[2], false, false, false, false)
					];
			...
			p: function update(ctx, [dirty]) {
				if (dirty & /*todoList*/ 1) {
					each_value = ensure_array_like_dev(/*todoList*/ ctx[0]);
					let i;
	...
	function create_fragment(ctx) {
		...
		const block = {
			...
			m: function mount(target, anchor) {
				...
				if (!mounted) {
					dispose = [
						listen_dev(button0, "click", /*onIncrement*/ ctx[3], false, false, false, false),
						listen_dev(button1, "click", /*onDecrement*/ ctx[4], false, false, false, false)
					];
